...
export const DatenschutzModal = ({ setIsDatenschutzOpen }: { setIsDatenschutzOpen: (open: boolean) => void }) => {
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6" role="dialog" aria-modal="true" aria-labelledby="modal-title">
      ...
      <div className="relative w-full max-w-3xl max-h-[85vh] bg-[#111] border border-white/10 rounded-2xl shadow-2xl overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-300" tabIndex={-1}>
        <div className="flex items-center justify-between p-6 border-b border-white/10 shrink-0">
          <h2 id="modal-title" className="text-2xl font-medium text-white">Datenschutzerklärung</h2>
          <button 
