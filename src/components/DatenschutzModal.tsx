    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6" role="dialog" aria-modal="true" aria-labelledby="modal-title">
      ...
      <div className="relative w-full max-w-3xl max-h-[85vh] max-h-[85dvh] bg-white/80 dark:bg-black/80 backdrop-blur-[20px] saturate-[180%] border border-black/10 dark:border-white/10 rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-300" tabIndex={-1}>
        <div className="flex items-center justify-between p-6 border-b border-black/5 dark:border-white/5 shrink-0">
          <h2 id="modal-title" className="text-2xl font-medium text-black dark:text-white">{t.privacy.title}</h2>
          <button 
        ...
        <div className="p-6 overflow-y-auto text-black/70 dark:text-white/70 text-sm leading-relaxed space-y-8">
          
          <section>
            <h3 className="text-lg font-medium text-black dark:text-white mb-3">{t.privacy.section1.title}</h3>
            <h4 className="text-base font-medium text-black/90 dark:text-white/90 mb-2">{t.privacy.section1.subtitle1}</h4>
            <p className="mb-4">
              {t.privacy.section1.text1}
            </p>
            <h4 className="text-base font-medium text-black/90 dark:text-white/90 mb-2">{t.privacy.section1.subtitle2}</h4>
          ...
          <section>
            <h3 className="text-lg font-medium text-black dark:text-white mb-3">{t.privacy.section2.title}</h3>
            <p className="mb-2">{t.privacy.section2.text1}</p>
            <h4 className="text-base font-medium text-black/90 dark:text-white/90 mb-2">{t.privacy.section2.subtitle1}</h4>
          ...
          <section>
            <h3 className="text-lg font-medium text-black dark:text-white mb-3">{t.privacy.section3.title}</h3>
            <h4 className="text-base font-medium text-black/90 dark:text-white/90 mb-2">{t.privacy.section3.subtitle1}</h4>
            <p className="mb-4">{t.privacy.section3.text1}</p>
            <h4 className="text-base font-medium text-black/90 dark:text-white/90 mb-2">{t.privacy.section3.subtitle2}</h4>
          ...
          <section>
            <h3 className="text-lg font-medium text-black dark:text-white mb-3">{t.privacy.section4.title}</h3>
            <h4 className="text-base font-medium text-black/90 dark:text-white/90 mb-2">{t.privacy.section4.subtitle2}</h4>
            <p className="mb-6">{t.privacy.section4.text5}</p>
          </section>

          <section>
            <h3 className="text-lg font-medium text-black dark:text-white mb-3">{t.privacy.section5.title}</h3>
            <h4 className="text-base font-medium text-black/90 dark:text-white/90 mb-2">{t.privacy.section5.subtitle1}</h4>
            <p className="mb-4">{t.privacy.section5.text1}</p>
            
            <h4 className="text-base font-medium text-black/90 dark:text-white/90 mb-2">{t.privacy.section5.subtitle2}</h4>
          ...
          <section>
            <h3 className="text-lg font-medium text-black dark:text-white mb-3">{t.privacy.section6.title}</h3>
            <p className="mb-4">{t.privacy.section6.text1}</p>
            <p className="mb-4">{t.privacy.section6.text2}</p>
            <p className="mb-4">{t.privacy.section6.text3}</p>
            <p>{t.privacy.section6.text4}</p>
          </section>
