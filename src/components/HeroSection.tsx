        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
          ...
          >
            <button 
              ...
              className="w-full sm:w-auto rounded-full px-6 py-2.5 lg:px-8 lg:py-3.5 bg-[radial-gradient(ellipse_at_center,white_0%,rgba(59,130,246,0.15)_100%)] border border-blue-500/50 text-black text-[13px] lg:text-[15px] font-medium tracking-wide shadow-[0_0_15px_rgba(37,99,235,0.2)] hover:shadow-[0_0_25px_rgba(37,99,235,0.4)] hover:bg-[radial-gradient(ellipse_at_center,white_0%,rgba(37,99,235,0.25)_100%)] hover:border-blue-400 transition-all duration-300 flex items-center justify-center"
            >
