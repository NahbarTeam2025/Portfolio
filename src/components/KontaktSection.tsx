...
export const KontaktSection = React.memo(({ 
  ...
  return (
    <div className="flex flex-col items-start gap-1 md:gap-4 w-full h-full animate-in fade-in duration-500 overflow-y-auto md:overflow-hidden">
      <h1 className="heading-gradient text-2xl md:text-4xl font-medium tracking-tight shrink-0">
        {t.contact.title}
      </h1>
      <div className="w-full h-[1px] bg-white/10 shrink-0" />
      <div className="flex flex-col gap-4 md:gap-6 w-full max-w-2xl mx-auto pt-1 md:pt-4 h-full">
        <div className="flex flex-col gap-6 md:gap-4 w-full">
          ...
          <div className="wow-card flex flex-col gap-4 md:gap-6 relative p-6 md:p-8">
            <div className="wow-card-border" />
            <div className="flex items-center gap-4 md:gap-6 group relative z-10">
              <div className="flex items-center justify-center shrink-0 w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/10 border border-white/20 group-hover:bg-white/20 transition-colors">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-white text-[15px] md:text-[18px] font-medium">Robert Erbach</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 md:gap-6 group">
              ...
              <div className="flex flex-col">
                ...
                <a href="mailto:roberterbach@web.de" className="text-white text-[15px] md:text-[18px] font-medium hover:text-blue-400 transition-colors break-all">roberterbach@web.de</a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 md:gap-6 group">
              ...
              <div className="flex flex-col">
                ...
                <a href="https://www.linkedin.com/in/robert-erbach-a173b2371" target="_blank" rel="noopener noreferrer" className="text-white text-[15px] md:text-[18px] font-medium hover:text-blue-400 transition-colors break-all">@roberterbach</a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 md:gap-6 group">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-white text-[15px] md:text-[18px] font-medium">{t.contact.locationValue}</span>
              </div>
            </div>

            {/* CV Download Section */}
            <div className="pt-4 md:pt-6 mt-2 border-t border-white/10">
              <div className="flex items-center gap-4 group">
                <div className="flex flex-col w-full">
                  <span className="text-white/60 text-[11px] md:text-[13px] uppercase tracking-widest font-bold mb-3">{t.contact.downloadCV}</span>
                  <div className="flex items-center gap-3">
                    {isCvUnlocked ? (
                      <a 
                        ...
                        className="flex items-center justify-center w-full gap-2 bg-white/10 hover:bg-white/20 border border-white/20 text-white transition-colors text-[14px] md:text-[16px] font-medium py-3 rounded-xl"
                      >
                      ...
                      <div className="flex items-center gap-4 w-full bg-black/20 p-4 rounded-xl border border-white/5">
                        <button 
                          onClick={() => setShowPasswordInput(!showPasswordInput)}
                          className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${showPasswordInput ? 'bg-blue-500' : 'bg-white/20'}`}
                        >
                          <span className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${showPasswordInput ? 'translate-x-5' : 'translate-x-0'}`} />
                        </button>
                        <span className="text-white/60 text-[13px] md:text-[15px] italic">{showPasswordInput ? t.contact.passwordPrompt : t.contact.unlockPrompt}</span>
                      </div>
                    )}
                  </div>
                </div>
