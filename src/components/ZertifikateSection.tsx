      ...
      {!showAllCerts && certs.length > 3 && expandedCert === null && (
        <div className="w-full flex justify-center md:hidden pb-0 pt-3 shrink-0">
          <button 
            ...
            className="flex items-center gap-2 px-6 py-2 rounded-full bg-white/5 border border-white/10 text-white/80 text-sm font-medium hover:bg-white/10 hover:text-white transition-all group"
          >
