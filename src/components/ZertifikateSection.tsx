    ...
    <div className="flex flex-col items-start gap-2 md:gap-3 w-full flex-grow animate-in fade-in duration-500">
      ...
      <div className="w-fit max-w-full mx-auto flex flex-col items-center justify-center pb-2 md:pb-4 pt-11 md:pt-9 gap-1 md:gap-1.5 mt-auto mb-4 md:mb-12 shrink-0">
        ...
        <button 
          ...
          className="w-full rounded-full py-2.5 lg:py-3.5 bg-[radial-gradient(ellipse_at_center,white_0%,rgba(59,130,246,0.15)_100%)] border border-blue-500/50 text-black text-[13px] lg:text-[15px] font-medium tracking-wide shadow-[0_0_15px_rgba(37,99,235,0.2)] hover:shadow-[0_0_25px_rgba(37,99,235,0.4)] hover:bg-[radial-gradient(ellipse_at_center,white_0%,rgba(37,99,235,0.25)_100%)] hover:border-blue-400 transition-all duration-300 flex items-center justify-center"
        >
