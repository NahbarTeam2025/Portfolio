...
export const SkillsSection = React.memo(({ handleNavigate }: any) => {
  ...
  return (
    <div className="flex flex-col items-start gap-1 md:gap-2 w-full flex-grow animate-in fade-in duration-500">
      ...
      {/* CTA Button */}
      <div className="w-fit max-w-full mx-auto flex flex-col items-center justify-center pb-1 md:pb-2 pt-2 md:pt-3 gap-1 md:gap-1 mt-auto mb-2 md:mb-4 shrink-0">
        <p className="text-black/80 text-[11px] md:text-xs text-center whitespace-normal md:whitespace-nowrap">
          {t.skills.cta.text}
        </p>
        <button 
          onClick={() => {
