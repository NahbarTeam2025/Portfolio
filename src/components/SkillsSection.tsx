    ...
    >
      ...
      <div className="w-fit max-w-full mx-auto flex flex-col items-center justify-center pb-1 md:pb-2 pt-11 md:pt-9 gap-1 md:gap-1 mt-auto mb-7 md:mb-9 shrink-0">
        ...
        <button 
          ...
          className="w-full rounded-full px-6 py-2.5 bg-gradient-to-r from-blue-500/20 via-white to-blue-500/20 border border-blue-500/50 text-black text-[13px] md:text-[14px] font-medium tracking-wide shadow-[0_0_15px_rgba(37,99,235,0.2)] hover:shadow-[0_0_25px_rgba(37,99,235,0.4)] hover:bg-blue-600/25 hover:border-blue-400 transition-all duration-300 flex items-center justify-center"
        >
