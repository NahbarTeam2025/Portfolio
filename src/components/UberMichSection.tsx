...
export const UberMichSection = React.memo(() => {
  return (
    <div className="flex flex-col items-start gap-2 md:gap-8 w-full h-full overflow-hidden animate-in fade-in duration-500">
      <h1 className="heading-gradient text-[24px] md:text-[40px] lg:text-[56px] font-medium leading-[1.1] tracking-tight shrink-0">
        Über mich
      </h1>
      <div className="w-full h-[1px] bg-white/10 shrink-0" />
      <div className="flex flex-col gap-2 md:gap-4 text-white/80 text-[14px] md:text-[16px] lg:text-[18px] font-normal max-w-[1000px] leading-snug md:leading-relaxed pt-1 md:pt-4 overflow-y-auto">
        <p>
        ...
        <p className="text-brand-teal font-medium tracking-wider text-[11px] md:text-[14px] lg:text-[16px] uppercase leading-relaxed">
